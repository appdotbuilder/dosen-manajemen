...
export default function EditLecturer({ lecturer }: Props) {
    const { data, setData, put, processing, errors } = useForm<LecturerFormData>({
        name: lecturer.name,
        nidn: lecturer.nidn || '',
        nuptk: lecturer.nuptk || '',
        study_program: lecturer.study_program,
        education_level: lecturer.education_level,
        education_institution: lecturer.education_institution || '',
        education_major: lecturer.education_major || '',
        education_year: lecturer.education_year ? lecturer.education_year.toString() : '',
        functional_position: lecturer.functional_position || '',
        rank: lecturer.rank || '',
        status: lecturer.status,
        teaching_subjects: lecturer.teaching_subjects || '',
        publications: lecturer.publications || '',
        community_service: lecturer.community_service || '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('lecturers.update', lecturer.id));
    };
            ...
            <div className="p-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">✏️ Edit Data Dosen</h1>
                            <p className="text-gray-600 mt-1">
                                Perbarui informasi {lecturer.name}
                            </p>
                        </div>
                    </div>
                </div>
